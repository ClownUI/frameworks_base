...
package com.android.systemui.clown.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.clown.header.STATUS_BAR_HEADER_UPDATE";
